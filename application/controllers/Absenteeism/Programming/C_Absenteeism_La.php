...
class C_Absenteeism_La  extends Controller {
    ...
    public function index() {
        ...
        $this->load->view('Absenteeism/Programming/V_Absenteeism_La', $data);
      ...
      public function ReportNews() {
        ...
        $this->load->view('Absenteeism/Programming/V_Absenteeism_Report_La', $data);
