...
class C_Machine_La extends Controller {
    ...
    public function ManageMachine() {
        ...
        $this->load->view('Production/Parameters/Machine/V_Create_Machines_La', $data);
    ...
    public function ListMachine() {
        ...
        $this->load->view('Production/Parameters/Machine/V_List_Machine_La', $data);
        //$Footer['sidebar_tabs'] = $this->load->view('Template/V_sidebar_tabs', null, true);
        $Footer['array_js'] = array(DATATABLES_JS, DATATABLES_JS_B, SWEETALERT_JS);
        $this->load->view('Template/V_Footer2', $Footer);
    }
    ...
    function ListTypeDamageAll() {
        ...
        $this->load->view('Production/Parameters/Machine/V_List_Damage_La', $data);
    ...
    function InfoMachine($id) {
        ...
        $data['id'] = $id;
        $this->load->view('Production/Parameters/Machine/V_Update_Machine_La', $data);
