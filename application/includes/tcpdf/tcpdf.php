...
//			$pagenumtxt = $w_page.$this->getAliasNumPage().' /algo '.$this->getAliasNbPages();  
//		} else {
//			$pagenumtxt = $w_page.$this->getPageNumGroupAlias().' /algomas '.$this->getPageGroupAlias();
//		}
		//$pagenumtxt = "IMPRESO POR USUARIO: ".strtoupper($_SESSION['nombre']." ".$_SESSION['apellido']).", EL ".strtoupper(strftime("%A %d de %B del %Y"));
                //setlocale(LC_ALL,"es_CO");
                $date = date_create();
		$pagenumtxt = strtoupper(date_format($date, 'd M Y g:i A'));  
		               
                //$pagenumtxt = "IMPRESO POR : ".strtoupper($_SESSION['nombre']." ".$_SESSION['apellido'])." EL ".strtoupper(strftime("%A %d de %B del %Y A LAS %I:%M:%S %p"));
