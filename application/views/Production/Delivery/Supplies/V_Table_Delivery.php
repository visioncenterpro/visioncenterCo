<table id="table_delivery" class="table table-bordered table-striped table-condensed ">
    ...
    <tbody>
        <?php  foreach ($rows as $t) : ?>
            <tr>
                <td ><button class="btn btn-block btn-primary btn-xs" onclick="InfoDelivery(<?=$t->id_delivery_supplies?>,'<?=$t->order?>')"><span class="fa fa-sign-in" aria-hidden="true"></span></button></td>
                <td style="text-align:center"><?=$t->id_delivery_supplies?></td>
