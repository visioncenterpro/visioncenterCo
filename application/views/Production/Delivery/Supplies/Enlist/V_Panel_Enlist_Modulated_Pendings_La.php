...
<script>
    ...
    function search(){
        ...
        $.post("<?= base_url()?>Production/Delivery/C_Delivery_La/search_modulated_pending",{array_order:array_order},function(data){
            console.log(data);
    ...
    function Excel_All(){
        ...
        $.post("<?= base_url()?>Production/Delivery/C_Delivery_La/excel_m",{array_order:array_order},function(data){
            console.log(data);
            var a=$("<a>");
            a.attr("href",data.data);
            $("body").append(a);
