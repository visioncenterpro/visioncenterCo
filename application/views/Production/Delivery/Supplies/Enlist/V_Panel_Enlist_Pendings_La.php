    ...
    <section class="content">
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title">Insumos pendientes por entregar a despachos</h3>
            </div>
            <div class="box-body">
                <div class="row">
                    <div class="col-md-12">
...
<script>
    ...
    function search(){
        ...
        $.post("<?= base_url()?>Production/Delivery/C_Delivery_La/search_supplies_pending",{array_order:array_order},function(data){
            console.log(data);
    ...
    function excel(order){
        $.post("<?= base_url()?>Production/Delivery/C_Delivery_La/excel_one",{order:order},function(data){
            console.log(data);
            var a=$("<a>");
    ...
    function Excel_All(){
        ...
        $.post("<?= base_url()?>Production/Delivery/C_Delivery_La/excel",{array_order:array_order},function(data){
            console.log(data);
            var a=$("<a>");
            a.attr("href",data.data);
            $("body").append(a);
