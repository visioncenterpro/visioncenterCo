...
<script>
    ...
    function AddDelivery() {
        if (ValidateInput("order")) {
            ...
            swal({
                ...
                if (result) {
                    var order = $("#order").val();
                    $.post("<?= base_url() ?>Production/Delivery/C_Delivery/CreateDeliverySupplies", {order: order}, function (data) {
                        if(data.res == "OK"){
                            window.location.href = "<?= base_url() ?>Production/Delivery/C_Delivery/InfoDeliverySupplies/" + data.id +"/"+ order+"/Delivery";;
    ...
    function InfoDelivery(id_delivery,order) {
        window.location.href = "<?= base_url() ?>Production/Delivery/C_Delivery/InfoDeliverySupplies/" + id_delivery +"/"+ order+"/Delivery";;
    }
</script>