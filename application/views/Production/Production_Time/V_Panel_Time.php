...
<script>
    ...
    function registerday() {
        ...
        /* VALIDA*/
        $.post("<?= base_url() ?>Production/Production_Time/C_Time/date_Consult", {dayOpen: dayOpen}, function (data) {
            if (data.res == null) {
                swal({
                ...
                $.post("<?= base_url() ?>Production/Production_Time/C_Time/date_register", {dayOpen: dayOpen}, function (data) {
    ...
    function recorder() {
        if (validatefield()) {
            ...
            $.ajax({
                url: "<?= base_url() ?>Production/Production_Time/C_Time/CreateTime",
                type: 'POST',
                data: formData,
                async: false,
    ...
    function Deleteday(id, day, titulo) {
        ...
        swal({
            ...
            if (result) {
                $.post("<?= base_url() ?>Production/Production_Time/C_Time/DeleteDay", {id: id, day: day}, function (data) {
