...
<script>
    ...
    function recorder() {
        if (validatefield()) {
            var dayOpen = $("#datepicker").val();
                    ...
                    $.ajax({
                        url: "<?= base_url() ?>Production/Production_Time/C_Budgets/CreBudgets",
                        type: 'POST',
                        data: formData,
                        async: false,
    ...
    function day_open() {
        ...
        $.post("<?= base_url() ?>Production/Production_Time/C_Budgets/watch_Budgets", {dayOpen: dayOpen}, function (data) {
    ...
    function update() {
          swal({
            ...
            if (result) {
                 ...
                 var formData = new FormData($('#form')[0]);
                    $.ajax({
                        url: "<?= base_url() ?>Production/Production_Time/C_Budgets/updateBudgets",
                        type: 'POST',
                        data: formData,
                        async: false,
                        success: function (data) {
