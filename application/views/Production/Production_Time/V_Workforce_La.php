...
<script>
    ...
    function registerday() {
        ...
        $.post("<?= base_url() ?>Production/Production_Time/C_Workforce_La/date_register", {dayOpen: dayOpen}, function (data) {
    ...
    function Deleteday(id, day, titulo) {
        ...
        swal({
            ...
            if (result) {
                $.post("<?= base_url() ?>Production/Production_Time/C_Workforce_La/DeleteDay", {id: id, day: day}, function (data) {
    ...
    function recorder() {
        if (validatefield()) {
            ...
            $.ajax({
                url: "<?= base_url() ?>Production/Production_Time/C_Workforce_La/Creaworkforce",
                type: 'POST',
                data: formData,
                async: false,
