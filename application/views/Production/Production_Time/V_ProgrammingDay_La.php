...
<script>
    ...
    function registerday() {
        ...
        $.post("<?= base_url() ?>Production/Production_Time/C_ProgrammingDay_La/valideprogrammingday", {dayOpen: dayOpen}, function (data) {
    ...
    function recorder() {
        if (validatefield()) {
            ...
            $.ajax({
                url: "<?= base_url() ?>Production/Production_Time/C_ProgrammingDay_La/Createprogrammingday",
                type: 'POST',
                data: formData,
                async: false,
    ...
    function update() {
        swal({
            ...
            if (result) {
                ...
                var formData = new FormData($('#form')[0]);
                $.ajax({
                    url: "<?= base_url() ?>Production/Production_Time/C_ProgrammingDay_La/updateProgrammingDay",
                    type: 'POST',
                    data: formData,
                    async: false,
                    success: function (data) {
