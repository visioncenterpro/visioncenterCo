...
<script>
    $(function () {
        ...
        $('.functions').iCheck({
            ...
            if (isChecked == true) {
                $.post("<?= base_url() ?>Production/Parameters/Machine/C_Machine/UpdateUserMachine", {id_machine: <?= $id ?>, id_function: this.value, option: "insert"}, function (data) {
                    if (data.res == "OK") {
                ...
                $.post("<?= base_url() ?>Production/Parameters/Machine/C_Machine/UpdateUserMachine", {id_machine: <?= $id ?>, id_function: this.value, option: "delete"}, function (data) {
                    if (data.res == "OK") {
        ...
        $('.users').iCheck({
            ...
            var isChecked = e.currentTarget.checked;
            if (isChecked == true) {
                $.post("<?= base_url() ?>Production/Parameters/Machine/C_Machine/UpdateAuxMachine", {id_machine: <?= $id ?>, id_user: this.value, option: "insert"}, function (data) {
                    if (data.res == "OK") {
                ...
                $.post("<?= base_url() ?>Production/Parameters/Machine/C_Machine/UpdateAuxMachine", {id_machine: <?= $id ?>, id_user: this.value, option: "delete"}, function (data) {
                    if (data.res == "OK") {
