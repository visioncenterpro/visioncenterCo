...
<script>
    ...
    function CreateType() {
        ...
        if (!error) {
            ...
            $.ajax({
                url: "<?= base_url() ?>Production/Parameters/Machine/C_Machine/CreateTypeDamage",
                type: 'POST',
                data: formData,
                async: false,
    ...
    function Updatetype(id_type_damage) {
        ...
        $.ajax({
            url: "<?= base_url() ?>Production/Parameters/Machine/C_Machine/UpdateTypeDamage",
            type: 'POST',
            data: formData,
            async: false,
            success: function (data) {
    ...
    function Delete(id_type_damage, titulo) {
        swal({
            ...
            if (result) {
                $.post("<?= base_url() ?>Production/Parameters/Machine/C_Machine/DeleteTypeDamage", {id_type_damage: id_type_damage}, function (data) {
                    if (data.res == "OK") {
