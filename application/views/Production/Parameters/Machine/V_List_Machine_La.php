...
<script>
    ...
    function Delete(id_machine, titulo) {
        swal({
            ...
            if (result) {
                $.post("<?= base_url() ?>Production/Parameters/Machine/C_Machine_La/DeleteMachine", {id_machine: id_machine}, function (data) {
                    if (data.res == "OK") {
    ...
    function Update(id_machine) {
        ...
        window.location = '<?= base_url(); ?>Production/Parameters/Machine/C_Machine_La/InfoMachine/' + id_machine;
