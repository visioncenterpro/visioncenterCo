...
<script>
    ...
    $(document).ready(function () {
        ...
        $("#btn_consult_supplies").click(function () {
            ...
            $.post(
                    "<?= base_url() ?>Production/Parameters/Supplies/C_Supplies/getSuppliesByFilter",
    ...
    function create() {
        ...
        if (validatefield()) {
            ...
            $.post(
                "<?= base_url() ?>Production/Parameters/Supplies/C_Supplies/createSupply",
                {
                    name : name,
                    code : code,
    ...
    function update() {
        ...
        if (validatefield()) {
            ...
            $.post(
                "<?= base_url() ?>Production/Parameters/Supplies/C_Supplies/updateSupply",
                {
                    id_supply : id_supply,
                    name : name,
                    code : code,
