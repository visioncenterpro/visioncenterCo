...
<script>
    ...
    function OpenModal(id_area) {
        ...
        $.post("<?= base_url() ?>Absenteeism/Panel/C_Panel_La/LoadDetailProg", {id_area: id_area}, function (data) {
    ...
    function registrarnov() {
        ...
        $.ajax({
            url: "<?= base_url() ?>Absenteeism/Panel/C_Panel_La/Createabsent",
            type: 'POST',
            data: formData,
            async: false,
    ...
    function registraraus() {
        ...
        $.ajax({
            url: "<?= base_url() ?>Absenteeism/Panel/C_Panel_La/Createnovelty",
            type: 'POST',
            data: formData,
            async: false,
            success: function (data) {
