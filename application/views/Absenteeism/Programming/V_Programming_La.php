...
<script>
    ...
    function Update(id_users) {
        window.location = '<?= base_url(); ?>Absenteeism/Programming/C_Programming_La/Infoperson/' + id_users;
    }
    function Create() {
        $("#form")[0].reset();
        $(".update").hide();
    ...
    function CreateUser() {
        ...
        if (!error) {
            ...
            $.ajax({
                url: "<?= base_url() ?>Absenteeism/Programming/C_Programming_La/CreateUser",
                type: 'POST',
                data: formData,
                async: false,
    ...
    function Delete(id_user, titulo) {
        swal({
            ...
            if (result) {
                $.post("<?= base_url() ?>Absenteeism/Programming/C_Programming_La/DeleteProgramming", {id_user: id_user}, function (data) {
                    if (data.res == "OK") {
