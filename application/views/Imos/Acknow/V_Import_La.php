...
<script>
    ...
    function SelectFile() {
        ...
        if ($(".seleccionado").length > 0) {
            ...
            $.post("<?= base_url() ?>Imos/Acknow/C_Import_La/Readfile", {folder: $(".seleccionado").text(),dir:$(".seleccionado").attr("rel"), option: 'load'}, function (data) {
                if (data.msg == "OK") {
                    $("#detalle").html("");
                    if (data.error != "") {
...
//                    RedirectLogin();
    ...
    function SAck(op){
        if ($("#order").val() != "") {
            ...
            $.ajax({
                url: "<?= base_url() ?>Imos/Acknow/C_Import_La/SaveAck",
                type: 'POST',
                data: formData,
                async: false,
    ...
    function SAck_update(op,data_salesline){
        if ($("#order").val() != "") {
            ...
            $.ajax({
                url: "<?= base_url() ?>Imos/Acknow/C_Import_La/UpdateAck",
                type: 'POST',
                data: formData,
                async: false,
                success: function (data) {
    ...
    function SaveAck() {
        if ($("#order").val() != "") {
            ...
            $.ajax({
                url: "<?= base_url() ?>Imos/Acknow/C_Import_La/vali_saveack",
                type: 'POST',
                data: formData,
                async: false,
                success: function (data) {
