...
<script>
    ...
    function UpdateComments(idbgpl,idproadmin){
        $.post("<?= base_url()?>Imos/Order/C_Order_La/UpdateComments",{order: '<?= $name ?>', idbgpl: idbgpl, comment:$("#comment").val()},function(data){
           if(data.res == "OK"){
    ...
    function Showbarcode(idproadmin, idbgpl, piece) {
        $.post("<?= base_url() ?>Imos/Order/C_Order_La/ChargedBarcode", {order: '<?= $name ?>', idbgpl: idbgpl}, function (data) {
            var images = "";
    ...
    function DetailsAditional(id,table,id_import_salestable){
        ...
        $.post("<?= base_url() ?>Imos/Order/C_Order_La/DetailsAditional", {id: id, table:table}, function (data) {
    ...
    function DeleteAditional(id,table) {
        ...
        swal({
            ...
            if (result) {
                $.post("<?= base_url() ?>Imos/Order/C_Order_La/DeleteDetailsPiece", {id: id,table:table}, function (data) {
                    if (data.res == "OK") {
    ...
    function DeleteDetailsPiece(id_pieces_line) {
        swal({
            ...
            if (result) {
                $.post("<?= base_url() ?>Imos/Order/C_Order_La/DeleteDetailsPiece", {id_pieces_line: id_pieces_line,order:'<?= $name ?>',id_salesline:<?= $id ?>}, function (data) {
                    if (data.res == "OK") {
    ...
    function AddNewAditional(){
        if(ValidateInput("codeAd") && ValidateInput("qtyAd")){
            ...
            $.ajax({
                url: "<?= base_url() ?>Imos/Order/C_Order_La/AddAditional",
                type: 'POST',
                data: formData,
                async: false,
    ...
    function AddNewPiece(){
        if (validatefield()) {
            ...
            $.ajax({
                    url: "<?= base_url() ?>Imos/Order/C_Order_La/AddPiece",
                    type: 'POST',
                    data: formData,
                    async: false,
                    success: function (data) {
    ...
    function DetailsPiece(idpieza){
        ...
        $.post("<?= base_url() ?>Imos/Order/C_Order_La/DetailsPiece", {id: idpieza}, function (data) {
            $(".required").val("");
            $(".cantos").val("N/A");
            $.each(data.res,function(e,i){
                $("#"+e).val(i);
    ...
    function UpdateAditional(id,table,id_import_salestable){
        if(ValidateInput("codeAd") && ValidateInput("qtyAd")){
            ...
            $.ajax({
                url: "<?= base_url() ?>Imos/Order/C_Order_La/UpdateAditional",
                type: 'POST',
                data: formData,
                async: false,
                success: function (data) {
    ...
    function UpdatePiece(idpieza){
        if (validatefield()) {
            ...
            formData.append("area", (parseInt($("#width").val())/1000) * (parseInt($("#height").val())/1000));
            $.ajax({
                    url: "<?= base_url() ?>Imos/Order/C_Order_La/UpdatePiece",
                    type: 'POST',
                    data: formData,
                    async: false,
                    success: function (data) {
