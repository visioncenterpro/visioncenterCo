<table cellpadding="3" style="width:100%; font-size: 7pt; margin-top: 5px;">
    <tr>
        <th colspan="5">
            ...
            <div style="text-align: center"><h1>CONSOLIDADO TOTAL DE HERRAJES</h1></div>
            <?php else: ?>
    ...
    <?= $data['tbody']; ?>
    <tr style="background-color: #e4e4e4;"><th style="text-align: right;" colspan="3">Total</th><th><?= $data['sum']; ?></th><th></th></tr>
</table>