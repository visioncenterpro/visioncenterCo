...
<table style="width:100%; font-size: 7pt; ">
    ...
    <tr style="background-color: #e4e4e4;">
        ...
        <th style="text-align: center">CODIGO (PIEZA)</th>
        <th style="text-align: center">ALTO</th>
        <th style="text-align: center">ANCHO</th>
        ...
        <th style="text-align: center;min-width: 52px;">CORTE</th>
        <th style="text-align: center;min-width: 52px;">ENCHAPE</th>
        <th style="text-align: center;min-width: 52px;">ALISTAMIENTO</th>
