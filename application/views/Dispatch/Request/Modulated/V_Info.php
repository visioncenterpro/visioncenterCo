...
<script>
        ...
        swal({
            ...
            if (result) {
                ...
                if (type2 == "M") {
                    ...
                    $.ajax({
                        url:  "<?= base_url() ?>Dispatch/C_Dispatch/goBack_Package_Supplies",
                        type: 'POST',
    ...
    function DeleteAll(type){
        swal({
            ...
            if (result) {
                ...
                $.post("<?= base_url() ?>Dispatch/C_Dispatch/DeleteAllPackRequestSD", {request:<?= $request->id_request_sd ?>, type: type,type2:type2}, function (data) {
                    if (data.res == "OK") {
                        $("#quantity_packages").val(data.num_packets);
                        $("#weight").val(data.total_weight_modulate);
                        $("#weight_supplies").val(data.total_weight_supplies);
    ...
    function DeleteSupplies(id_request_detail,id_order_package,order){
        swal({
            ...
            if (result) {
                ...
                $.post("<?= base_url() ?>Dispatch/C_Dispatch/DeleteSuppliesRequestSD", {request:<?= $request->id_request_sd ?>, id_request_detail:id_request_detail,id_order_package:id_order_package,order:order,type:type}, function (data) {
                    if (data.res == "OK") {
                        $("#quantity_packages").val(data.num_packets);
                        $("#weight").val(data.total_weight_modulate);
                        $("#weight_supplies").val(data.total_weight_supplies);
    ...
    function DeleteAllSupplies(type){
        swal({
            ...
            if (result) {
                ...
                $.post("<?= base_url() ?>Dispatch/C_Dispatch/DeleteAllSuppliesRequestSD", {request:<?= $request->id_request_sd ?>, type: type, type2:type2}, function (data) {
                    if (data.res == "OK") {
                        $("#tab-body").html(data.tabs);
                        InitializeCheck();
                    } else {
    ...
    function Delete(id_request_detail, id_order_package, type, order) {
        swal({
            ...
            if (result) {
                ...
                $.post("<?= base_url() ?>Dispatch/C_Dispatch/DeletePackRequestSD", {id_request_detail: id_request_detail, request:<?= $request->id_request_sd ?>, type: type, type2:type2}, function (data) {
                    if (data.res == "OK") {
                        $("#quantity_packages").val(data.num_packets);
                        $("#weight").val(data.total_weight_modulate);
                        $("#weight_supplies").val(data.total_weight_supplies);
    ...
    function UpdateRequest2(){
        ...
        if((<?= $request->status ?> == 17) && (Math.round($("#weightI").val()) > $("#max_weight").val())){
            ...
            $.post("<?= base_url() ?>Dispatch/C_Dispatch/UpdateRequestSD2", {request:<?= $request->id_request_sd ?>, driver:driver, value:value, vehicle:vehicle,quantity_packages:quantity_packages,type:type}, function (data) {
    ...
    function AddPack(id_order_package) {
        if (parseInt($("#t-balance").text()) > 0) {
            if ($("#quantity-split").val() > 0 && $("#quantity-split").val() <= parseInt($("#t-balance").text())) {
                ...
                $.post("<?= base_url() ?>Dispatch/C_Dispatch/AddPackSDToRequest", {order: order, id_order_package: id_order_package,id_forniture:id_forniture, quantity: quantity, request:<?= $request->id_request_sd ?>, name: name, pack: pack, weight: weight, type: type, id_delivery_detail:id_delivery_detail}, function (data) {
                    if (data.res == "OK") {
                        $("#quantity_packages").val(data.num_packets);
                        $("#weight").val(data.total_weight_modulate);
                        $("#weightI").val((data.total_weight_modulate + (data.total_weight_modulate *<?= PORCENT_WEIGHT ?>)) + data.total_weight_supplies);
    ...
    function delete_item_group(){
        swal({
            ...
            if (result) {
                ...
                $.post("<?= base_url() ?>Dispatch/C_Dispatch/DeletePackRequestSDGroup", {request:<?= $request->id_request_sd ?>, id_forniture:id_forniture,type:type,order:order}, function (data) {
                    console.log(data);
                    if (data.res == "OK") {
                        $("#quantity_packages").val(data.num_packets);
                        $("#weight").val(data.total_weight_modulate);
    ...
    function delete_item_group2(){
        swal({
            ...
            if (result) {
                ...
                $.post("<?= base_url() ?>Dispatch/C_Dispatch/DeletePackRequestSDGroup2", {request:<?= $request->id_request_sd ?>, id_forniture:id_forniture,type:type,order:order,observation:observation}, function (data) {
                    if (data.res == "OK") {
                        $("#quantity_packages").val(data.num_packets);
                        $("#weight").val(data.total_weight_modulate);
                        $("#weightI").val((data.total_weight_modulate + (data.total_weight_modulate *<?= PORCENT_WEIGHT ?>)) + data.total_weight_supplies);
    ...
    function modal_goBackP(){
        ...
        var id_forniture = json.id_forniture;
        var order = json.order;
        $.post("<?= base_url() ?>Dispatch/C_Dispatch/get_data_goBackP", {request:<?= $request->id_request_sd ?>, id_forniture:id_forniture, order:order}, function (data) {
    ...
    function delete_supplies_group(){
        swal({
            ...
            if (result) {
                ...
                $.post("<?= base_url() ?>Dispatch/C_Dispatch/DeleteSuppliesRequestSDGroup", {request:<?= $request->id_request_sd ?>, id_order_package_supplies:id_order_package_supplies,type:type,order:order}, function (data) {
                    console.log(data);
                    if (data.res == "OK") {
                        $("#quantity_packages").val(data.num_packets);
                        $("#weight").val(data.total_weight_modulate);
