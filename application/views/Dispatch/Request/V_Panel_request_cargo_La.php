...
<script>
    ...
    function detail(id_request_cargue){
        window.location = '<?= base_url() ?>Dispatch/C_Dispatch_La/request_cargo_detail/'+id_request_cargue;
    }
    ...
    function create_new(){
        swal({
            ...
            if (result) {
                $.post("<?= base_url() ?>Dispatch/C_Dispatch_La/create_data_cargo", {}, function (data) {
                    window.location = '<?= base_url() ?>Dispatch/C_Dispatch_La/request_cargo_detail/'+data;
                }, 'json').fail(function (error) {});
            }
        }).catch(swal.noop);
    }
