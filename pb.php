...
<head>
	...
	<title>JS Bin</title>
	<link rel="stylesheet" href="http://192.168.5.209/VisionCenter/dist/css/font-google.css">
...
<body>
	...
	<div class="content-wrapper" id="app">
		<form-wizard title="Creación de proyecto" subtitle="" finish-button-text="Guardar" back-button-text="Atrás" next-button-text="Siguiente" @on-complete="save()">
			<form class="form-pb">
				<tab-content title="Datos de la construcción">
					<div class="row">
		                <div class="col-md-12">
	...
	var app = new Vue({
		...
		methods: {
		    save: function(){
		        ...
		        var vali = 0;
		        console.log(document.querySelectorAll(".form-pb input"));
