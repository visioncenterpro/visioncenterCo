		                                            ...
		                                            <div class="box box-primary">
		                                                ...
		                                                <div class="box-body">
		                                                        ...
		                                                        <div class="form-group">
		                                                            ...
		                                                            <input type="text" v-model="newProject.value_kitchen" name="value_kitchen" class="form-control" placeholder="value_kitchen" />
		                                                        </div>
		                                                        <div class="form-group">
		                                                            <label>value_closet_vest</label>
		                                                            <input type="text" v-model="newProject.value_closet_vest" name="value_closet_vest" class="form-control" placeholder="value_closet_vest" />
		                                                        </div>
		                                                        <div class="form-group">
		                                                            <label>value_vanities</label>
		                                                            <input type="text" v-model="newProject.value_vanities" name="value_vanities" class="form-control" placeholder="value_vanities" />
		                                                        </div>
		                                            ...
		                                            <div class="box box-primary">
		                                                ...
		                                                <div class="box-body">
		                                                    ...
		                                                    <div class="form-group">
		                                                        ...
		                                                        <input type="text" v-model="newProject.value_doors_frames" name="value_doors_frames" class="form-control" placeholder="value_doors_frames" />
		                                                    </div>
		                                                    <div class="form-group">
		                                                        <label>value_others</label>
		                                                        <input type="text" v-model="newProject.value_others" name="value_others" class="form-control" placeholder="value_others" />
		                                                    </div>
		                                                    <div class="form-group">
		                                        ...
		                                        <div class="col-md-6">
		                                            <div class="box box-primary">
		                                                ...
		                                                <div class="box-body">
		                                                    ...
		                                                    <div class="form-group">
		                                                        <label>longitude_construction {{newProject.longitude_construction}}</label>
	...
	var app = new Vue({
		...
		methods: {
		    save: function(){
		        ...
		        var vali = 0;
		        //console.log(this.newProject['id_project_construccion']);
